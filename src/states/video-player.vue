          ...
          <div class="inner-page">
            <div class="title">
              <h3>
                ...
                dolore magna aliqua.Ut enim ad minim veniam, consectetur adipisicing elit, sed do eiusmod tempor
              ...
              <ul>
                ...
                <li>
                  <a href="#">
                    <img src="../assets/images/sub.png" title="subscribe" />subscribe
                  </a>
                </li>
              </ul>
            </div>
            <div class="video-inner">
              <iframe
                src="//player.vimeo.com/video/24681824"
                width="100%"
                height="500px"
                frameborder="0"
              ...
              <ul>
                ...
                <li>
                  <span>
                    ...
                    labore et dolore magna aliqua. Ut enim ad minim veniam, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua.consectetur adipisicing elit, sed do eiusmod tempor
            ...
            <div class="share-artical">
              ...
              <ul>
                <li>
                  <a href="#">
                    <img src="../assets/images/facebook.png" title="facebook" />Facebook
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="../assets/images/twiter.png" title="Twitter" />Twiiter
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="../assets/images/in.png" title="linked-in" />Linked-in
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="../assets/images/google+.png" title="google+" />Google+
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="../assets/images/pintrest.png" title="pintrest" />Pintrest
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="../assets/images/rss.png" title="rss" />Rss
                  </a>
                </li>
              </ul>
            </div>
...
@font-face {
  ...
  src: url("../assets/fonts/GandhiSans-Regular-webfont.eot?#iefix") format("embedded-opentype"),
...
.social-icons li a {
  ...
  display: block;
  text-indent: -9999px;
  background: transparent url(../assets/images/social-icons.png);
}
